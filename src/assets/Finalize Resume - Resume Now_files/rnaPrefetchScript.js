...
var vendorBundleSrc = 'https://@@env.' + hostParts[1] + '.com/payment/build/vendor.bundle-1.0.0.500.js';
var developerBundleSrc = 'https://@@env.' + hostParts[1] + '.com/payment/build/app.bundle-1.0.0.500.js';
var plansBundleSrc = 'https://@@env.' + hostParts[1] + '.com/payment/build/plans-1.0.0.500.bundle.js';
var appJsSrc = 'https://@@env.' + hostParts[1] + '.com/payment/scripts/app-1.0.0.500.js';
var ecomWidget = 'https://@@env.' + hostParts[1] + '.com/payment/build/widget.bundle-1.0.0.500.js';
...
var mainCssSrc = 'https://@@env.' + hostParts[1] + '.com/payment/stylesheets/rna/main-1.0.0.500.css';
var resFileName = 'dev-1.0.0.500.json';
...
switch (hostParts[0]) {
    ...
    case 'pen':
        ...
        blobFolder = 'reg/';
        resFileName = 'reg-1.0.0.500.json';
        break;
    case 'stg':
    case 'stg-app':
        env = 'stg-assets';
        blobFolder = 'stg/';
        resFileName = 'stg-1.0.0.500.json';
        break;
    case 'qa':
    case 'qa-app':
        env = hostParts[0] + '-assets';
    ...
    case 'www':
        env = 'assets';
        blobFolder = 'prod/';
        resFileName = 'prod-1.0.0.500.json';
        break;
}
var localizedTextJsonPath = baseUrl.replace('@@env', env) + '/contents/' + blobFolder + 'resume-now.com/localizedText-1.0.0.500.json';
var ecomJsonPath = baseUrl.replace('@@env', env) + '/contents/' + blobFolder + 'common/localizedText-1.0.0.500.json';
...
function loadImageFiles() {
    var imageList = [];
    imageList.push('/blobimages/ecom/rna/synergy-images/images/yellow-gradient.png');
    imageList.push('images/rna/exit-intent-modal-images/demo-resume.png');
    imageList.push('images/rna/exit-intent-modal-images/flex-job-modal-image.png')
    imageList.push('images/rna/exit-intent-modal-images/static-steps-img.png')
    imageList.push('images/rna/exit-intent-modal-images/free-tag.png')
