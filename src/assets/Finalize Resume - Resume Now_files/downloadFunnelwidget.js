...
DFW.DF_Exp_AdSlot = '';
DFW.isFFFToolExp = false;
DFW.isFFFToolMobExp = false;
...
DFW.Widget = (function (scope) {
  ...
  function loadCss () {
    if(DFW.fullPageDFExpVariant == 4 || DFW.Config.baselineFullscreenDF || DFW.isFullScreenIntlDfnl){
    ...
    const loadFullpagecss = GetDeviceTypeUsingUserAgent() == 'desktop' ? (DFW.isFullPageDFExp || DFW.Config.baselineFullscreenDF || DFW.isFullScreenIntlDfnl) : GetDeviceTypeUsingUserAgent() == 'tablet' ? DFW.Config.baselineFullscreenDF : false;
    if (DFW.Environment == "dev") {
      ...
      if (loadFullpagecss) {
        if(DFW.isFullScreenIntlDfnl){
          ...
          if(urlLinikSplit[1] && urlLinikSplit[1].includes("wlbdemo") && readCookie("wlbdemo") == "wlb") {
            ...
            DFW.isRebrandThemeUserExp ? addLinkTag("stylesheet", getFileName(DFW.LocalBaseurl + "build/stylesheet/" + DFW.PortalCd+"-rb" + "/mainFullPage.css")): addLinkTag("stylesheet", getFileName(DFW.LocalBaseurl + "build/stylesheet/" + DFW.PortalCd + "/mainFullPage.css"));
            if (window.location.pathname && window.location.pathname.indexOf('/documenthome') > -1) {
              addLinkTag("stylesheet", getFileName(DFW.LocalBaseurl + "build/stylesheet/" + DFW.PortalCd + "/main.css"));
            }
          }
        ...
        DFW.isRebrandThemeUserExp ?  addLinkTag("stylesheet", getFileName(DFW.LocalBaseurl + "build/stylesheet/" + DFW.PortalCd+"-rb" + "/main.css")) : addLinkTag("stylesheet", getFileName(DFW.LocalBaseurl + "build/stylesheet/" + DFW.PortalCd + "/main.css"));
      }
    }
    else {
      ...
      if (DFW.isINTLJoshua) {
        ...
        if(DFW.isINTLFlow){
          ...
          if(urlLinikSplit[1] && urlLinikSplit[1].includes("wlbdemo") && readCookie("wlbdemo") == "wlb" && (DFW.Environment.toLowerCase() == "qa" || DFW.Environment.toLowerCase() == "reg")) {
            ...
            DFW.isRebrandThemeUserExp ? addLinkTag("stylesheet", getFileName((DFW.subDomainUrl || DFW.Baseurl) + "blobcontent/dfnl/" + DFW.Environment + "/stylesheet/" + DFW.PortalCd+"-rb" + "/mainFullPage.css")): addLinkTag("stylesheet", getFileName((DFW.subDomainUrl || DFW.Baseurl) + "blobcontent/dfnl/" + DFW.Environment + "/stylesheet/" + DFW.PortalCd + "/mainFullPage.css"));
            if (window.location.pathname && window.location.pathname.indexOf('/documenthome') > -1) {
              addLinkTag("stylesheet", getFileName((DFW.subDomainUrl || DFW.Baseurl) + "blobcontent/dfnl/" + DFW.Environment + "/stylesheet/" + DFW.PortalCd + "/main.css"));
            }
          }
        ...
        DFW.isRebrandThemeUserExp? addLinkTag("stylesheet", getFileName((DFW.subDomainUrl || DFW.Baseurl) + "blobcontent/dfnl/" + DFW.Environment + "/stylesheet/" + DFW.PortalCd+"-rb" + "/main.css")) : addLinkTag("stylesheet", getFileName((DFW.subDomainUrl || DFW.Baseurl) + "blobcontent/dfnl/" + DFW.Environment + "/stylesheet/" + DFW.PortalCd + "/main.css"));
      }
    }
  }
  ...
  var handleCLAndCVLocalization = function(result, resolve) {
    ...
    DFW.cultureValue = DFW.Config.localizationFileName;
  ...
  function checkBrowserCompatibility() {
    ...
    Promise.all([
      ...getLocalization(), userClaimsPromise
    ])
  ...
  function renderDownloadFunnelWidget(data) {
    ...
    widgetProps= {
      ...
      userProps: {
        ...
        downloadLinkExpVariant: GetDeviceTypeUsingUserAgent() == 'desktop' ? DFW.downloadLinkExpVariant : -1, enableColorProgressV2: DFW.enableColorProgressV2, docPreviewUrl: DFW.docPreviewUrl,
        ...
        openFullScreenDownloadFunnel: GetDeviceTypeUsingUserAgent() == 'desktop' ? (DFW.Config.baselineFullscreenDF || DFW.isFullPageDFExp || DFW.isFullScreenIntlDfnl) : GetDeviceTypeUsingUserAgent() == 'tablet' ? DFW.Config.baselineFullscreenDF : false,
        ...
        isFullPageDFV2Exp: GetDeviceTypeUsingUserAgent() == 'desktop' ? DFW.fullPageDFV2Exp : false,
        isBoldProOptionsExp: GetDeviceTypeUsingUserAgent() == 'mobile' && DFW.boldProOptionExpVariant > 2 && (DFW.isPremium || DFW.paymentStatus == 'Expired' || DFW.Config.isBoldProFree) ? true : false,
        ...
        boldProOptionExpVariant: GetDeviceTypeUsingUserAgent() == 'mobile' && DFW.boldProOptionExpVariant > 2 && (DFW.isPremium || DFW.paymentStatus == 'Expired' || DFW.Config.isBoldProFree) ? DFW.boldProOptionExpVariant : -1,  
        ...
        loadAllConfigs: DFW.loadAllConfigs,
        boldProOptInCopyExpVariant: GetDeviceTypeUsingUserAgent() != 'mobile' ? DFW.boldProOptInCopyExpVariant : DFW.boldProOptInCopyMobileExpVariant,
        friendFamilyFeedbackToolExp: !(DFW.feedbackCommentsData && DFW.feedbackCommentsData[DFW.ResumeGuid]) && DFW.isFFFToolExp && GetDeviceTypeUsingUserAgent() != 'mobile' ? DFW.fFToolExpVariant: -1,
        feedbackToolShareableUrl: `${DFW.Baseurl}feedback/document/${DFW.ResumeGuid}`,    
        friendFamilyFeedbackToolMobExp: !(DFW.feedbackCommentsData && DFW.feedbackCommentsData[DFW.ResumeGuid]) && DFW.isFFFToolMobExp && GetDeviceTypeUsingUserAgent() == 'mobile' ? DFW.fFToolMobExpVariant: -1,
         ...
         boldProTransitionExp: GetDeviceTypeUsingUserAgent() != 'mobile' && DFW.boldProTransitionExpVariant > 2 ? DFW.boldProTransitionExpVariant : -1,
         ...
         isBoldProAddSlotClnExpUser:GetDeviceTypeUsingUserAgent() != 'mobile' && DFW.isBoldProAddSlotClnExpUser,
         isRsmReviewSubmitted: DFW.isRsmReviewSubmitted,
         rexOrderId: DFW.rexOrderId || 0,
         isRebrandTheme:DFW.isRebrandThemeUserExp
      },
      isModalOpen: DFW.isModalOpen,
      TrackDFWWidgetEvent: TrackDFWWidgetEventCallback,
      SetUserPref: SetUserPreference,
  ...
  let getAllFeedbackToolDocComments = function (userId) {
    if (
      (DFW.isFFFToolExp &&
        getUserExperimentVariant(DFW.Config.friendsFamilyFeedbackExpId) > 2) ||
      (DFW.isFFFToolMobExp &&
        getUserExperimentVariant(DFW.Config.friendsFamilyFeedbackMobileExpId) > 2)
    ) {
  ...
  function handleLocalizationConfig(result, resolve) {
    ...
    if(DFW.isLitePortal || containsSeparateConfig) {
      ...
      DFW.cultureValue = containsSeparateConfig ? data.Config.localizationFileName: DFW.cultureValue;
  ...
  var isFreeRsmReviewAvailable = function (apiUrl, userId, deviceType) {
    return new Promise(function (resolve, reject) {
      if (DFW.Config.isNowPortal || DFW.Config.isNoFRRAdBaslined || (DFW.multiChoiceFrontExpVariant > 2)) {
        callAjax(
          apiUrl +
          "payments/" +
          userId +
          ...
          function (result) {
            try {
              ...
              if (data) {          
                ...
                if(!isFRRAvail){
                  getRexOrders(DFW.Config.apiPathV1, userId);
                }             
  ...
  function getRexOrders(apiUrl, userId, docWorkflowCD="rESRVW") {
    if(DFW.multiChoiceFrontExpVariant > 2){
      return new Promise(function (resolve, reject) {
        callAjax(
          `${apiUrl}users/${userId}/rexorders?docWorkflowCD=${docWorkflowCD}`,
          "GET",
          false,
          true,
          function (result) {
            var data = JSON.parse(result);
            if (data) {      
              const rsmReviewStepId = getResumeReviewStageByStepCd(data[0].stepCD);
              DFW.rexOrderId = data[0].rexOrderID;
              if(rsmReviewStepId > 1){
                DFW.isRsmReviewSubmitted = true;
              }
              resolve && resolve(true);
            } else {
              reject && reject();
  ...
  var isWebsiteCreated = function (apiUrl, userId) {
    return new Promise(function (resolve, reject) {
      ...
      else if (DFW.boldProfileDFAdExpVariant > 2 ||  DFW.Config.baselineFullscreenDF || DFW.Config.isNowPortal || DFW.Config.getProfileData || DFW.isFullScreenIntlDfnl|| DFW.isBoldProAddSlotExpUser || DFW.isBoldProAddSlotClnExpUser) {
        callAjax(
          ...
          function (result) {
            ...
            if (data) {
              if(data && data.length > 0){
               ...
               if(DFW.isBoldProAddSlotExpUser || DFW.isBoldProAddSlotClnExpUser){
  ...
  var getExperimentsPromise = function (userID) {
    ...
    return new Promise(function (resolve, reject) {
      if (DFW.viewVariation || updatedDFWConfig.disbaleGetExperiment) {
        ...
        DFW.isFFFToolExp = updatedDFWConfig.friendsFamilyFeedbackExpId && getUserExperimentVariant(updatedDFWConfig.friendsFamilyFeedbackExpId) > 2;
        DFW.fFToolExpVariant = updatedDFWConfig.friendsFamilyFeedbackExpId && getUserExperimentVariant(updatedDFWConfig.friendsFamilyFeedbackExpId);
        DFW.boldProOptionExpVariant = updatedDFWConfig.boldProOptionsExpId && getUserExperimentVariant(updatedDFWConfig.boldProOptionsExpId);
        DFW.isBoldProOptionsExp = updatedDFWConfig.boldProOptionsExpId && getUserExperimentVariant(updatedDFWConfig.boldProOptionsExpId) > 2;
        DFW.isFFFToolMobExp = updatedDFWConfig.friendsFamilyFeedbackMobileExpId && getUserExperimentVariant(updatedDFWConfig.friendsFamilyFeedbackMobileExpId) > 2;
        DFW.fFToolMobExpVariant = updatedDFWConfig.friendsFamilyFeedbackMobileExpId && getUserExperimentVariant(updatedDFWConfig.friendsFamilyFeedbackMobileExpId);
        ...
        DFW.fullPageDFV2Exp = updatedDFWConfig.fullPageDFV2Exp && getUserExperimentVariant(updatedDFWConfig.fullPageDFV2Exp) > 2;
        DFW.resumeLinkExpVariant = updatedDFWConfig.resumeLinkExpId && getUserExperimentVariant(updatedDFWConfig.resumeLinkExpId);
        DFW.boldProTransitionExpVariant = updatedDFWConfig.boldProTransitionExpId && getUserExperimentVariant(updatedDFWConfig.boldProTransitionExpId);
        ...
        DFW.isRebrandThemeUserExp= updatedDFWConfig.retentionRebrandExpId && (getUserExperimentVariant(updatedDFWConfig.retentionRebrandExpId) > 2 || getUserExperimentVariant(updatedDFWConfig.rebrandCvrExpId) > 2);
        DFW.boldProOptInCopyMobileExpVariant = updatedDFWConfig.boldProOptInCopyMobileExpId && getUserExperimentVariant(updatedDFWConfig.boldProOptInCopyMobileExpId);
